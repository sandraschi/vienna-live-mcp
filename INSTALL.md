...
git clone https://github.com/sandraschi/vienna-live-mcp
cd vienna-live-mcp
just
```
...
4. Start the server:
   ...
   uv run python -m vienna_live_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn vienna_live_mcp.server:app --port 10879
   ```
5. Open `http://localhost:10879` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/vienna-live-mcp/issues) |
